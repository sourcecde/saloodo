							...
							<table class="table table-striped table-hover" id="table-invoice">
								...
								<?php foreach ($invoices as $invoice ) : ?>
									<tr>
										...
										<td><?php echo  anchor('admin/invoices/detail/'.$invoice->id,'Details',['class'=>'btn btn-success btn-xs']) ?>
										<?php else:?>
										<td><?php echo  anchor('admin/invoices/detail/'.$invoice->id,'Details',['class'=>'btn btn-primary btn-xs']) ?>
										<?php endif;?>
										</td>
									</tr>
									<?php endforeach; ?>
