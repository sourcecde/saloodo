				...
				<div class="col-md-12">
					<div class="panel panel-default">
						...
						<hr>
							...
							<div class="col-md-3">
								<h4>User ID</h4>
									<?php echo  $member->usr_id  ?>
							</div>
							
							<div class="col-md-3">
								<h4>User Name </h4>
								<?php echo  $member->usr_name  ?>
							</div>
							...
							<div class="col-md-2">
								...
								<?php echo  anchor('admin/products/disable_usr/'.$member->usr_id,'Disabled ',['class'=>'btn btn-danger btn-xs ',
									'onclick'=>'return confirm(\'Are You Sure You Want Disabled This user ? \')'
								])  ?>
								
								<?php echo  anchor('#','Active',['class'=>'btn btn-success btn-xs disabled '
								])  ?>
								<?php else:?>
								<?php echo  anchor('#','Disabled ',['class'=>'btn btn-danger btn-xs disabled'])  ?>
								
								<?php echo  anchor('admin/products/active_usr/'.$member->usr_id,'Active ',['class'=>'btn btn-success btn-xs ',
									'onclick'=>'return confirm(\'Are You Sure You Want Disabled This  user ? \')'
								])  ?>
								<?php endif;?>
								<?php endif;?>
