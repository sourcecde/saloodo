				...
				<div class="col-md-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4><i class="fa fa-fw fa-compass"></i> Products <?php echo  anchor('admin/products/create','Add New Product',['class'=>'btn btn-primary btn-xs']) ?></h4>
							...
							<table class="table table-striped table-hover" id="tableproducts">
								...
								<?php foreach ($products as $product ) : ?>
									<tr>
										...
										<td><textarea rows="4" disabled><?php echo  $product->pro_description  ?></textarea></td>
