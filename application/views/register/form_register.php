                    ...
                    <div class="panel-body" width="100px">
						<div class="col-md-12">
							<?php echo validation_errors() ?>
								<hr>
							<div class="col-md-3"><?php echo $this->session->flashdata('error') ?></div>
							<div class="col-md-6">
							<?php echo form_open('register') ?>
								<div class="form-group">
									<label for="username">User Name : </label>
									<input type="text" class="form-control" name="rusername" value="<?php echo set_value('rusername') ?>">
								</div>
								<div class="form-group">
								...
								<div class="col-md-3">
									<?php echo  anchor('Login','Login',['class'=>'btn  btn-default']) ?>
								</div>
								</div>
							<?php echo form_close() ?>
							</div>
