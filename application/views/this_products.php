			...
			<div class="col-md-3">
                <div class="panel panel-default">
                    <div class="panel-heading">
						<h6><?php echo  $come->pro_name  ?> - <?php echo  $come->pro_title  ?></h6>
                    </div>
                    <div class="panel-body">
                        ...
                        <p id="t"> <?php echo  $come->pro_description  ?></p>
						<p><code>Price:</code> <?php echo  $come->pro_price  ?>  <code> Stock:</code> <?php echo  $come->pro_stock  ?> </p>
                         <?php  if($this->session->userdata('group')	!=	'1'  and $this->session->userdata('group')	!=	'2' ): ?>
						<?php echo  anchor('home/add_to_cart/'.$come->pro_id.'/'.$send,'Add To Cart || Buy',['class'=>'btn btn-success  btn-xs','role'=>'button']) ?>
                        <ul class="nav nav-tabs navbar-right">
							<li class="dropdown">
								<a class="dropdown-toggle" data-toggle="dropdown">Report <i class="fa fa-exclamation-triangle"></i></a> 
								<ul class="dropdown-menu">
									<li>
										<?php echo  anchor('home/report/'.$come->pro_id,"I don't  like this Product",["class'=>'btn  btn-xs"]) ?>
									</li>
								</ul>
							</li> 
						</ul>
						<?php else:?>
						<?php echo  anchor('admin/products/edit/'.$come->pro_id,'Edit',['class'=>'btn btn-success btn-xs']) ?>
						<?php echo  anchor('admin/products/delete/'.$come->pro_id,'Delete',['class'=>'btn btn-danger btn-xs',
