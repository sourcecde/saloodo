	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
				<div class="container">
					...
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="<?php echo base_url(); ?>"><?php foreach($get_sitename as $sitename):?><?php echo  $sitename->all_value_settings;?><?php endforeach;?></a>
					</div>
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li class="dropdown">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown"> My Cart <?php echo $this->cart->total_items(); ?> <i class="fa fa-shopping-cart"> </i> <b class="caret"> </b></a>
								<ul class="dropdown-menu">
									...
									<li>
										...
										?>
										<?php echo anchor('home/cart',$url_cart); ?>
									...
									<li>
											...
											<?php echo anchor('order',$url_order); ?>
											<?php else:?>
											<?php echo anchor(base_url(),$url_order); ?>
											<?php endif ;?>
									</li>
								</ul>
							</li>
