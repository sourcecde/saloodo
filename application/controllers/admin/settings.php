...
class Settings extends CI_Controller {
	...
	public function edit_sitename()
	{
		...
		if ($this->form_validation->run() == FALSE)
		{
				...
				$edit_sitename_is = array('all_value_settings' => set_value('edit_sitename_input'));
	...
	public function edit_footer()
	{
		...
		if ($this->form_validation->run() == FALSE)
		{
				...
				$edit_footer_is = array('all_value_settings' => set_value('edit_footer_input'));
				...
				if($valid_user	==	FALSE)
					{
						...
						$this->session->set_flashdata('error','Username / Password Not Correct !' );
							...
							$new_admin_password = array('usr_password'	=> set_value('password_admin'));							
