...
class Home extends CI_Controller {
	...
	public function add_to_cart($pro_id,$send)
	{
		...
		$data = array('id' => $product->pro_id,'qty' => 1,'price' => $product->pro_price,'name' => $product->pro_name,
	...
	public function report($pro_id)
	{
		...
		$report_products = array('rep_id_product' => $product->pro_id,'rep_name' => $product->pro_name,
			'rep_title_product'			=> $product->pro_title,'rep_usr_name' => $name_usr,'rep_usr_group' => $group_usr);
